...
{
	public static class Serializer implements RecipeSerializer< CardboardColorRecipe >
	{
		@Override
		public CardboardColorRecipe fromJson( ResourceLocation recipeId, JsonObject json )
		{
			...
			return new CardboardColorRecipe( recipeId, s, i, j, nonNullList, itemstack );
		}

		@Override
		public CardboardColorRecipe fromNetwork( ResourceLocation recipeId, FriendlyByteBuf buffer )
		{
		...
		@Override
		public void toNetwork( FriendlyByteBuf buffer, CardboardColorRecipe recipe )
		{
	...
	public CardboardColorRecipe(	ResourceLocation idIn, String groupIn, int recipeWidthIn, int recipeHeightIn,
	...
	public ItemStack assemble( CraftingContainer inv )
	{
		...
		for( int i = 0; i < inv.getContainerSize(); ++i )
		{
			...
			if( !ingredientStack.isEmpty() )
			{
				...
				if( !( item instanceof IDyeableItem ) || !resultStack.isEmpty() )
	...
	{
		return BetterStorageRecipes.COLOR_CARDBOARD.get();
	}
