...
public class CardboardHoeItem extends HoeItem implements ICardboardItem
{
	public CardboardHoeItem()
	{
		super( Tiers.WOOD, 0, -3.0F, new Item.Properties() );// .tab( BetterStorage.CREATIVE_MODE_TAB ) );
	}
