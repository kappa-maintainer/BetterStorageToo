...
public class CardboardAxeItem extends AxeItem implements ICardboardItem
{
	public CardboardAxeItem()
	{
		super( Tiers.WOOD, 6.0F, -3.2F, new Item.Properties() );// .tab( BetterStorage.CREATIVE_MODE_TAB ) );
	}
