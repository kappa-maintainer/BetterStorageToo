...
public class LockerContainerScreen extends AbstractContainerScreen< LockerContainerMenu >
{
	private final int	columns, rows;
	private final int	offsetX;
	private final int	offsetY;

	public LockerContainerScreen( LockerContainerMenu container, Inventory playerInventory, Component title )
	{
